...
#         super(ModelCheckpoint1, self).__init__()
        ...
        self.sep = ','
        self.filename = '/work/vsankar/Project-Luna/Codes/t_a_01_c_t_s_t_z_f.log'
        self.append = True
        self.writer = None
        self.keys = None
...
#     Tracer()()
    ...
    adm = Adam(lr=0.01, beta_1=0.9, beta_2=0.999, epsilon=1e-08, decay=0.0)
    model.compile(loss='categorical_crossentropy',
                  optimizer=adm,
                  metrics=['accuracy'])

  
    filepath = "/work/vsankar/Project-Luna/Luna_weights/luna_weights_temp.hdf5"

    model.load_weights('/work/vsankar/Project-Luna/Luna_weights/luna_weights_temp.hdf5')

    save_model_per_epoch = ModelCheckpoint1(filepath, monitor='val_loss', verbose=1, save_best_only=False)
#     Tracer()()
